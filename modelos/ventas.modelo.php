...
class ModeloVentas{
	...
	/* ===============================
   INGRESAR VENTA DESDE AJAX (Touch UI)
   =============================== */
public static function mdlIngresarVentaRapida($tabla, $datos) {
  $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla
    (codigo, id_cliente, id_vendedor, productos, impuesto, neto, total, metodo_pago, monto_pago)
