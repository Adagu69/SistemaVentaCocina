	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			foreach ($ventas as $row => $item){
				...
				$nombreCliente = is_array($cliente) && isset($cliente["nombre"]) ? $cliente["nombre"] : "Cliente desconocido";
				$vendedor = ControladorUsuarios::ctrMostrarUsuarios("id", $item["id_vendedor"]);
				$nombreVendedor = is_array($vendedor) && isset($vendedor["nombre"]) ? $vendedor["nombre"] : "Vendedor desconocido";
